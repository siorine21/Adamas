...
/* 性格は攻撃↑防御↑特攻↑特防↑素早さ↑の5group×4（無補正との組はてれや等の5種）の順。
   yakkun等の性格対応表と同じ並びに揃えている（攻撃系→防御系→特攻系→特防系→素早さ系→無補正）。
   既存キーの文字列は変えていないので、保存済みチームの性格指定はそのまま有効。 */
export const NATURES: Record<string, Nature> = {
  "さみしがり（A↑B↓）": { up: "A", down: "B" },
  "いじっぱり（A↑C↓）": { up: "A", down: "C" },
  "やんちゃ（A↑D↓）": { up: "A", down: "D" },
  "ゆうかん（A↑S↓）": { up: "A", down: "S" },
  "ずぶとい（B↑A↓）": { up: "B", down: "A" },
  "わんぱく（B↑C↓）": { up: "B", down: "C" },
  "のうてんき（B↑D↓）": { up: "B", down: "D" },
  "のんき（B↑S↓）": { up: "B", down: "S" },
  "ひかえめ（C↑A↓）": { up: "C", down: "A" },
  "おっとり（C↑B↓）": { up: "C", down: "B" },
  "うっかりや（C↑D↓）": { up: "C", down: "D" },
  "れいせい（C↑S↓）": { up: "C", down: "S" },
  "おだやか（D↑A↓）": { up: "D", down: "A" },
  "おとなしい（D↑B↓）": { up: "D", down: "B" },
  "しんちょう（D↑C↓）": { up: "D", down: "C" },
  "なまいき（D↑S↓）": { up: "D", down: "S" },
  "おくびょう（S↑A↓）": { up: "S", down: "A" },
  "せっかち（S↑B↓）": { up: "S", down: "B" },
  "ようき（S↑C↓）": { up: "S", down: "C" },
  "むじゃき（S↑D↓）": { up: "S", down: "D" },
  "てれや（無補正）": {},
  "がんばりや（無補正）": {},
  "すなお（無補正）": {},
  "きまぐれ（無補正）": {},
